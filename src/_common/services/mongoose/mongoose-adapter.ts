...
// import { AdapterType } from '../mongoDb/types';
// import mongooseClinet from './mongoose-client';
...
// class MongooseService implements AdapterType {

//     async readAll(model: Model<any>, filter?: Filter<IObject>, sortBy = "_id", sortDirection: 1 | -1 = 1) {

//         const collection: Collection<Document> = mongooseClinet.database.collection(collectionName)
